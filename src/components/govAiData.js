...
- **Agencies**: **KWSP / EPF** (i-Akaun Majikan) & **PERKESO / SOCSO** (ASSIST Portal).`,
      eligibility: {
        title: 'Food & Beverage Business Eligibility Pre-Check',
        summary: 'Confirm you meet these statutory criteria before starting your applications:',
        criteria: [
          { id: 'c1', label: 'Citizenship', requirement: 'Malaysian Citizen or Permanent Resident (MyKad / MyPR)', isMandatory: true },
          { id: 'c2', label: 'Age Limit', requirement: 'Aged 18 years and above', isMandatory: true },
          { id: 'c3', label: 'Health Status', requirement: 'Mandatory Typhoid vaccination (TY2) for all food handlers', isMandatory: true },
          { id: 'c4', label: 'Training Accreditation', requirement: 'Accredited Food Handler Training Course (SLPM) by KKM', isMandatory: true },
          { id: 'c5', label: 'Premise Zoning', requirement: 'Commercial / approved PBT zoning with BOMBA safety clearance', isMandatory: true },
        ],
      },
      journey: {
        id: 'journey-food-biz',
        ...
        steps: [
          ...
          },
          {
            ...
            agency: 'Lembaga Hasil Dalam Negeri (LHDN)',
            description: 'Register business income tax file (Form B) and enable MyInvois e-Invoicing compliance.',
            dependencies: ['step-ssm'],
